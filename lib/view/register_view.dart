...
Map<String, double> generateRandomPoint() {
  double initialLatitude = 37.785834;
  double initialLongitude = -122.406417;
  Random random = Random();
  // Convert radius from meters to degrees
  double radiusInDegrees = 1000 / 111000;
  ...
  double newLatitude = x / cos(toRadians(initialLongitude));

  double foundLongitude = y + initialLongitude;
  double foundLatitude = newLatitude + initialLatitude;
...
class _MyRegisterViewState extends State<MyRegisterView> {
  ...
  //Function to create random position

  Object randomUserPosition = generateRandomPoint();
  Object Messages = {};
